...
namespace margelo::nitro::mlkit::labeling {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ImageLabel).
   */
  struct ImageLabel final {
  public:
  ...
  public:
    ImageLabel() = default;
    explicit ImageLabel(std::string text, double confidence, double index): text(text), confidence(confidence), index(index) {}

  public:
    friend bool operator==(const ImageLabel& lhs, const ImageLabel& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ImageLabel <> JS ImageLabel (object)
  template <>
  struct JSIConverter<margelo::nitro::mlkit::labeling::ImageLabel> final {
    static inline margelo::nitro::mlkit::labeling::ImageLabel fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mlkit::labeling::ImageLabel(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mlkit::labeling::ImageLabel& arg) {
