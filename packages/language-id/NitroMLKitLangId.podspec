...
Pod::Spec.new do |s|
  ...
  # imports "NitroMLKitLangId-Swift.h", so the compiled Swift module name has to be NitroMLKitLangId.
  s.module_name  = "NitroMLKitLangId"
  ...
  load 'nitrogen/generated/ios/NitroMLKitLangId+autolinking.rb'
