...
namespace margelo::nitro::mlkit::text {
  ...
  /**
   * A struct which can be represented as a JavaScript object (TextRect).
   */
  ...
  public:
    TextRect() = default;
    explicit TextRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const TextRect& lhs, const TextRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ TextRect <> JS TextRect (object)
  template <>
  struct JSIConverter<margelo::nitro::mlkit::text::TextRect> final {
    static inline margelo::nitro::mlkit::text::TextRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mlkit::text::TextRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mlkit::text::TextRect& arg) {
