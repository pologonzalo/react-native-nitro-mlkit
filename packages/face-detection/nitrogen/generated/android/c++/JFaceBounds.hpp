...
namespace margelo::nitro::mlkit::face {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "FaceBounds" and the Kotlin data class "FaceBounds".
   */
  struct JFaceBounds final: public jni::JavaClass<JFaceBounds> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitromlkit/face/FaceBounds;";
