...
namespace margelo::nitro::mlkit::face {
  ...
  /**
   * A struct which can be represented as a JavaScript object (CroppedFace).
   */
  struct CroppedFace final {
  public:
    std::string uri     SWIFT_PRIVATE;
    double faceIndex     SWIFT_PRIVATE;
    double width     SWIFT_PRIVATE;
    double height     SWIFT_PRIVATE;

  public:
    CroppedFace() = default;
    explicit CroppedFace(std::string uri, double faceIndex, double width, double height): uri(uri), faceIndex(faceIndex), width(width), height(height) {}

  public:
    friend bool operator==(const CroppedFace& lhs, const CroppedFace& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ CroppedFace <> JS CroppedFace (object)
  template <>
  struct JSIConverter<margelo::nitro::mlkit::face::CroppedFace> final {
    static inline margelo::nitro::mlkit::face::CroppedFace fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mlkit::face::CroppedFace(
        JSIConverter<std::string>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "uri"))),
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "faceIndex"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mlkit::face::CroppedFace& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "uri"), JSIConverter<std::string>::toJSI(runtime, arg.uri));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "faceIndex"), JSIConverter<double>::toJSI(runtime, arg.faceIndex));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "faceIndex")))) return false;
