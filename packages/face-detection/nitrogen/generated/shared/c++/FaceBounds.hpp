...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::mlkit::face::FaceBounds> final {
    static inline margelo::nitro::mlkit::face::FaceBounds fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mlkit::face::FaceBounds(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mlkit::face::FaceBounds& arg) {
