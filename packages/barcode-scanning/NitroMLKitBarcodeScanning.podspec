...
Pod::Spec.new do |s|
  ...
  # imports "NitroMLKitBarcode-Swift.h", so the compiled Swift module name has to be NitroMLKitBarcode.
  s.module_name  = "NitroMLKitBarcode"
  ...
  load 'nitrogen/generated/ios/NitroMLKitBarcode+autolinking.rb'
