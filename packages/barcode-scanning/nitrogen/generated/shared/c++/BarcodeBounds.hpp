...
namespace margelo::nitro::mlkit::barcode {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BarcodeBounds).
   */
  struct BarcodeBounds final {
  public:
  ...
  public:
    BarcodeBounds() = default;
    explicit BarcodeBounds(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const BarcodeBounds& lhs, const BarcodeBounds& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ BarcodeBounds <> JS BarcodeBounds (object)
  template <>
  struct JSIConverter<margelo::nitro::mlkit::barcode::BarcodeBounds> final {
    static inline margelo::nitro::mlkit::barcode::BarcodeBounds fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mlkit::barcode::BarcodeBounds(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mlkit::barcode::BarcodeBounds& arg) {
