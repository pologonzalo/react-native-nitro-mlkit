...
**`@nitro-mlkit/barcode-scanning`** · on-device Google ML Kit via [Nitro Modules](https://github.com/mrousavy/nitro) — JSI, no bridge.
...
```json
{ "plugins": ["@nitro-mlkit/barcode-scanning"] }
```
