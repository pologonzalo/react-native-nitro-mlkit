...
Pod::Spec.new do |s|
  ...
  # imports "NitroMLKitSelfieSeg-Swift.h", so the compiled Swift module name has to be NitroMLKitSelfieSeg.
  s.module_name  = "NitroMLKitSelfieSeg"
  ...
  load 'nitrogen/generated/ios/NitroMLKitSelfieSeg+autolinking.rb'
