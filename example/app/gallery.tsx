...
const s = StyleSheet.create({
  ...
  themeLabel: { color: C.text, fontFamily: F.bodySemi, fontSize: 14 },
  ...
  chipText: { color: C.text, fontFamily: F.bodySemi, fontSize: 13, textTransform: "capitalize" },
  chipCount: { color: C.faint, fontFamily: F.mono, fontSize: 12, fontVariant: ["tabular-nums"] },
